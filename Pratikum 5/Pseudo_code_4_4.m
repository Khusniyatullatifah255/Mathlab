...
G3 = [-3,-3,5;-3,0,5;-3,5,5];
G4 = [-3,-3,-3;-3,0,5;5,5,5];
G5 = [-3,-3,-3;-3,0,-3;5,5,5];
G6 = [5,-3,-3;5,0,-3;5,5,-3];
G7 = [5,5,5;-3,0,-3;-3,-3,-3];
...
for n = 1: N
    for m = 1 : M
        GS(n,m) = max(max(max(max(max(max(max(Gs1(n,m),Gs2(n,m)), ...
            Gs3(n,m)),Gs4(n,m)), Gs5(n,m)), Gs6(n,m)), Gs7(n,m)), ...
            Gs8(n,m));
    end;
end;
